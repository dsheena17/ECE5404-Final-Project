...
set id 88
set name dut_mac_muladd_8s_8s_8ns_8_4_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename covMatrix \
    op interface \
    ports { covMatrix_address0 { O 8 vector } covMatrix_ce0 { O 1 bit } covMatrix_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'covMatrix'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { standarisedData_address0 { O 8 vector } standarisedData_ce0 { O 1 bit } standarisedData_we0 { O 1 bit } standarisedData_d0 { O 64 vector } } \
} "
} else {
