...
set name dut_mul_32ns_32ns_64_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {mul} IMPL {auto} LATENCY 1 ALLOW_PRAGMA 1
}


set name dut_dmul_64ns_64ns_64_8_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_standarisedData_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_pca_m_pcVals_0_RAM_AUTO_0R0W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_pca_m_pcVals_1_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_pca_m_pcVecs_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_r \
    op interface \
    ports { input_r_address0 { O 11 vector } input_r_ce0 { O 1 bit } input_r_we0 { O 1 bit } input_r_d0 { O 64 vector } input_r_q0 { I 64 vector } input_r_address1 { O 11 vector } input_r_ce1 { O 1 bit } input_r_we1 { O 1 bit } input_r_d1 { O 64 vector } input_r_q1 { I 64 vector } } \
} "
} else {
