...
$(ObjDir)/main.o: ../../../../main.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -IC:/Vitis_Libraries/quantitative_finance/L1/tests/pca/../../../L1/include/xf_fintech -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/main.d

$(ObjDir)/dut.o: ../../../../dut.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../dut.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -IC:/Vitis_Libraries/quantitative_finance/L1/tests/pca/../../../L1/include/xf_fintech -IC:/Vitis_Libraries/quantitative_finance/L1/tests/pca/../../../../solver/L2/include  $(IFLAG) $(DFLAG) $< -o $@ ; \
