...
set name dut_mul_32ns_34ns_65_2_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename this_m_pcVecs \
    op interface \
    ports { this_m_pcVecs_address0 { O 7 vector } this_m_pcVecs_ce0 { O 1 bit } this_m_pcVecs_we0 { O 1 bit } this_m_pcVecs_d0 { O 64 vector } this_m_pcVecs_address1 { O 7 vector } this_m_pcVecs_ce1 { O 1 bit } this_m_pcVecs_we1 { O 1 bit } this_m_pcVecs_d1 { O 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'this_m_pcVecs'"
}
}
