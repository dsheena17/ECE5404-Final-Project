...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.dut.autotvin_rows.dat"
         "c.dut.autotvin_cols.dat"
         "c.dut.autotvin_input_r.dat"
         "c.dut.autotvin_outputComponents_0.dat"
         "c.dut.autotvin_outputComponents_1.dat"
         "c.dut.autotvin_outputComponents_2.dat"
         "c.dut.autotvin_outputLoadings_0.dat"
         "c.dut.autotvin_outputLoadings_1.dat"
         "c.dut.autotvin_outputLoadings_2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.dut.autotvout_input_r.dat"
         "rtl.dut.autotvout_outputComponents_0.dat"
         "rtl.dut.autotvout_outputComponents_1.dat"
         "rtl.dut.autotvout_outputComponents_2.dat"
         "rtl.dut.autotvout_outputExplainedVariance_0.dat"
         "rtl.dut.autotvout_outputExplainedVariance_1.dat"
         "rtl.dut.autotvout_outputExplainedVariance_2.dat"
         "rtl.dut.autotvout_outputLoadings_0.dat"
         "rtl.dut.autotvout_outputLoadings_1.dat"
         "rtl.dut.autotvout_outputLoadings_2.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
