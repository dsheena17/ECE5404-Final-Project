...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename pcVecsNorm \
    op interface \
    ports { pcVecsNorm_address0 { O 4 vector } pcVecsNorm_ce0 { O 1 bit } pcVecsNorm_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pcVecsNorm'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename pcVecsNorm_1 \
    op interface \
    ports { pcVecsNorm_1_address0 { O 4 vector } pcVecsNorm_1_ce0 { O 1 bit } pcVecsNorm_1_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pcVecsNorm_1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename pcVecsNorm_2 \
    op interface \
    ports { pcVecsNorm_2_address0 { O 4 vector } pcVecsNorm_2_ce0 { O 1 bit } pcVecsNorm_2_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'pcVecsNorm_2'"
}
}
